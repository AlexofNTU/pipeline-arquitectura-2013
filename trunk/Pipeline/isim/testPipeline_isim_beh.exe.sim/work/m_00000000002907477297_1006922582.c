...
static unsigned int ng1[] = {541196320U, 0U};
static int ng2[] = {0, 0};
static unsigned int ng3[] = {543358977U, 0U};
static int ng4[] = {1, 0};
static unsigned int ng5[] = {4399110U, 0U};
static int ng6[] = {2, 0};
static int ng7[] = {3, 0};
...
{
	static char *pe[] = {(void *)Initial_31_0,(void *)Always_87_1,(void *)Cont_92_2};
